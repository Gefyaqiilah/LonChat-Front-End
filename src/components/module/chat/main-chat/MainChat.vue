<template>
    <div :class="!getShowContactInfo ? 'right-side show col-sm-12 col-lg-8 p-0' : 'right-side show col-sm-12 col-lg-4 p-0'">
...
export default {
  name: 'MainChat',
  props: ['socket', 'handleBackMobile', 'hideContactList'],
  data () {
    return {
      input: {
        message: ''
